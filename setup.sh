...
curl -L https://dl.google.com/linux/direct/chrome-remote-desktop_current_amd64.deb > /tmp/crd.deb; \
  ...
  curl -L https://releases.hashicorp.com/terraform/0.15.3/terraform_0.15.3_linux_amd64.zip > /tmp/terraform.zip; \
  ...
  mkdir /tmp/helm-unz; \
  curl -L https://get.helm.sh/helm-v3.5.4-linux-amd64.tar.gz | gzip -dc | tar -C /tmp/helm-unz -xf -; \
