...
apt-get update; \
  ...
  apt-get -y install sudo locales less dialog apt-utils man-db ripgrep tree bc guile-3.0 zsh fish zip unzip zstd sudo tmux bat parallel vim emacs-nox git iproute2 procps lsb-release libnss3-tools curl httpie jq sqlite3 docker.io docker-compose docker-buildx; \
