...
apt-get update; \
  ...
  apt-get -y install locales dialog apt-utils man-db bc zsh fish zip unzip sudo tmux bat vim emacs-nox git iproute2 procps lsb-release libnss3-tools build-essential autoconf automake cmake m4 bison flex gettext httpie jq; \
